...
### Export Low Stock Variants

To export all product variants with stock levels below 100 to a CSV file:

```bash
ts-node ./src/scripts/export-low-stock-variants.ts
```

This will generate a `low-stock-variants.csv` file in the project root with the following columns:
